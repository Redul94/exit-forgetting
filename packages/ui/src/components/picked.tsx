      ...
      >
        ...
        <Dialog.Portal>
          ...
          >
            <Dialog.Description marginTop={280}>
              <YStack backgroundColor="white" marginBottom={20}>
                ...
                <Stack alignItems="center">
                  <CheckCircle color="green" size={'$10'} height={100} />
                </Stack>
                ...
                <XStack>
                  <Button icon={Book} marginRight={13} backgroundColor={'grey'} borderRadius={20}>
                    Learn More
                  </Button>
                  <Button icon={Coffee} backgroundColor={'grey'} borderRadius={20}>
                    Buy me a coffee
                  </Button>
                </XStack>
              </YStack>
            ...
            <Fieldset gap="$4" horizontal></Fieldset>
